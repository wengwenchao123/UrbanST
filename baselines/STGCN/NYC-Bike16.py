...
from basicts.metrics import masked_mae, masked_mape, masked_rmse,masked_corr,node_pcc
...
DATA_NAME = 'NYC-Bike16'  # Dataset name
...
MODEL_PARAM = {
    "Ks" : 3,
    "Kt" : 3,
    "blocks" : [[4], [64, 16, 64], [64, 16, 64], [128, 128], [24]],
    "T" : 12,
    "n_vertex" : 250,
    "act_func" : "glu",
